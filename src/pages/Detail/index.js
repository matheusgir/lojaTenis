   ...
   <ScrollView style={styles.container}>
    ...
    <View>
      ...
      <View style={styles.textContent}>
        ...
        <Text style={styles.textContent}>O Nike Downshifter 10 traz suporte e amortecimento atualizados. Seu design leve e acolchoado ajuda a manter você se movimentando enquanto corre.</Text>
